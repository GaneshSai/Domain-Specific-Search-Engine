...
def upd(IP_Query_result):
    if IP_Query_result is not None:
        # # print(type(IP_Query_result))
        # '''
        # IP_Query_result = str(IP_Query_result, encode())
        # flag_update_sql = '''UPDATE Information_Security SET Flag = '1' where
        #                    URLs = '{IP_Query_result}' '''.format(IP_Query_result=IP_Query_result)
        #        '''
        flag_update_sql=''
        # print(IP_Query_result)
       
        try:
            flag_update_sql = '''UPDATE Information_Security SET Flag = '1' where
                           URLs = '{IP_Query_result}' '''.format(IP_Query_result=IP_Query_result.decode())
